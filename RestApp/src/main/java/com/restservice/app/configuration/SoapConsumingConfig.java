...
import com.restservice.app.repository.soapRepository.*;
...
@Configuration
@ComponentScan(basePackages = "com.restservice.app")
public class SoapConsumingConfig {

    @Bean
    public Jaxb2Marshaller marshaller() {
        Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
        marshaller.setContextPath("com.restservice.app.dto.database");
        return marshaller;
    }
